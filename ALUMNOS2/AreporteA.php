...
$target_dir = "../ALUMNOS2/".strtoupper($idA).'/';
$carpeta=$target_dir;
...
$q = $mysqli->query("SELECT * FROM reportes   WHERE no_control = '$idA'");
...
if( mysqli_num_rows($q) == 0){
    ...
    $tamanio = $_FILES['fileToUpload']['size'];
            ...
            $sql = "INSERT INTO  reportes(tamanioR1,tipoR1,nombre_archivoR1, no_control) VALUES('$tamanio','$tipo','$nombre', '$idA')";
    ...
    if(mysqli_num_rows($q) > 0){  
        ...
        $tamanio = $_FILES['fileToUpload']['size'];
        $db=new Conect_MySql();
        $sql = " UPDATE reportes    SET      tamanioR1=' $tamanio'  ,    tipoR1=' $tipo' ,  nombre_archivoR1 = '$nombre'  where no_control='$idA'";         
        $query = $db -> execute($sql); 
} 
    ...
    switch ($error_code) {
        case UPLOAD_ERR_OK:
            $error_message = "No hubo error, archivo subido correctamente.";
            break;
        case UPLOAD_ERR_INI_SIZE:
            $error_message = "El archivo excede el tamaño máximo permitido por el servidor (upload_max_filesize).";
            break;
        case UPLOAD_ERR_FORM_SIZE:
            $error_message = "El archivo excede el tamaño máximo permitido por el formulario (MAX_FILE_SIZE).";
            break;
        ...
        case UPLOAD_ERR_NO_TMP_DIR:
            $error_message = "Falta la carpeta temporal en el servidor.";
            break;
        ...
        case UPLOAD_ERR_EXTENSION:
            ...
            break;
        default:
            $error_message = "Error desconocido. Código: $error_code";
            break;
    }

    $errors[] = "Lo sentimos, hubo un error subiendo el archivo. Detalle: $error_message";
    }
}
