...
if( mysqli_num_rows($q) == 0){
    ...
    $tamanio = $_FILES['fileToUpload']['size'];
            ...
            $sql = "INSERT INTO  reportes(tamanioR2,tipoR2,nombre_archivoR2, no_control) VALUES('$tamanio','$tipo','$nombre', '$idA')";
    ...
    if(mysqli_num_rows($q) > 0){  
        ...
        $tamanio = $_FILES['fileToUpload']['size'];
        $db=new Conect_MySql();
        $sql = " UPDATE reportes    SET      tamanioR2=' $tamanio'  ,    tipoR2=' $tipo' ,  nombre_archivoR2 = '$nombre'  where no_control='$idA'";         
        $query = $db -> execute($sql); 
} 
