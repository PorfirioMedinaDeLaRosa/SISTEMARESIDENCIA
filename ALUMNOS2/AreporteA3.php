...
if( mysqli_num_rows($q) == 0){
    ...
    $tamanio = $_FILES['fileToUpload']['size'];
            ...
            $sql = "INSERT INTO  reportes(tamanioR3,tipoR3,nombre_archivoR3, no_control) VALUES('$tamanio','$tipo','$nombre', '$idA')";
    ...
    if(mysqli_num_rows($q) > 0){  
        ...
        $tamanio = $_FILES['fileToUpload']['size'];
        $db=new Conect_MySql();
        $sql = " UPDATE reportes    SET      tamanioR3=' $tamanio'  ,    tipoR3=' $tipo' ,  nombre_archivoR3 = '$nombre'  where no_control='$idA'";         
        $query = $db -> execute($sql); 
} 
