  ...
  <div class="row">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title">Cargar Carta</h3>
      </div>
      <div class="panel-body">
		...
		<h4>Carta de presentación </h4>
          ...
          <form method="POST" action="CPresentacion.php" enctype="multipart/form-data">
<div class="">
          ...
          <button class="" type="submit">Cargar Fichero</button>
          </form>
        </div>
