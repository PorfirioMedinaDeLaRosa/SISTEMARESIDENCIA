...
$idproyecto = $datosP['idproyecto'];
    ...
    <div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
            <h4>Encuesta de salida</h4>
            <h5>Subir un archivo PDF por nombre su número de control más la terminación ES</h5>
            <h5>Ejemplo 20CS0001ES</h5>
			<h5 ><a href="https://forms.gle/64kcoj722QEbuuv28" target="_blank">Realizar encuesta de salida</a></h5>
			
             <div class="modal-body">
            <form >
              <input  id="no_control" name="no_control" type="hidden"  value="<?php echo strtoupper($_SESSION["no_control"]); ?>">
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "ESEVIDENCIA.php",        // Url to which the request is send
