...
WHERE proyectos.no_control = asignacionproyecto.no_controlp AND tb_residentes.no_control = asignacionproyecto.no_control   AND asignacionproyecto.no_control ='$idGT';
           ...
           echo "<a class='btn btn-success btn-raised btn-xs ' href='documentoreportecalificaciones.php?no_control=" .$datos['no_control'] ." & nombre=" .$datos['nombre'] ." ".$datos['ap'] ." ".$datos['am'] ." &  carrera=" .$datos['carrera'] ."  '><span class='glyphicon glyphicon-actualizar'></span>Generar Reporte Calificaciones</a>"; 
