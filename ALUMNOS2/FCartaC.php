...
// Cargando el fichero en la carpeta "subidas"
 ...
 if( mysqli_num_rows($q) == 0){
     ...
     if ($nombre != "") {
            ...
            $db=new Conect_MySql();
            $sql = "INSERT INTO tramitesgestion(tamanioCA,tipoCA,nombre_archivoCA, no_control) VALUES('$tamanio','$tipo','$nombre', '$idGT')";
 ...
 $sql = " UPDATE  tramitesgestion SET      nombre_archivoCA ='$nombre'  where no_control='$no_control'";         
 $query = $db -> execute($sql); 
