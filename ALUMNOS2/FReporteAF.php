        ...
        <div class="col-xs-12">
          ...
          <div class="table-responsive">
            ...
            <?php
              ...
              $sqle = "SELECT * from tb_residentes where no_control ='$idGT'";
...
<div class="full-box tile-number text-titles">
  ...
  <a href="formatoreporte.php?no_control=' .$datosA['no_control'] ." & nombre=" .$datosA['nombre'] ." ".$datosA['ap'] ." ".$datosA['am'] ." &  carrera=" .$datosA['carrera'] .'"><span class="glyphicon glyphicon-actualizar"></span>Descargar evaluación</a>
...
<div class="full-box tile-number text-titles">
  ...
  <a href="documentoreportefinal.php?no_control=' . $datosA['no_control'] . " & nombre=" . $datosA['nombre'] . " " . $datosA['ap'] . " " . $datosA['am'] . " &  carrera=" . $datosA['carrera'] .    ' "><span class="glyphicon glyphicon-actualizar"></span>Descargar evaluación</a>
 </div>
</article>
';
...
//}else{
//  echo' <h2>SI DESEA DESCARGAR EL FORMATO DE EVALUACIÓN BIMESTRAL DEBE CUMPLIR CON LOS DOCUMENTOS DE GESTIÓN 
//  TECNOLÓGICA, CARTA DE ACEPTACIÓN, ACUERDO DE TRABAJO, CARTA DE PRESENTACIÓN.<h2>';
//}
                    ...
                    if($datos['statusCL'] =='Aceptado'){
                      ...
                      <div class="full-box tile-number text-titles">
                        <p class="full-box">1</p>
                        <a href="FCA.php">DESCARGAR</a>
                      </div>
                    </article>';
             
                    }else
                    {
                    // echo' <h2>SI DESEA DESCARGAR EL FORMATO DE EVALUACIÓN FINAL DEBE CUMPLIR CON LA CARTA DE LIBERACIÓN, EL PASO 12 DEL SISTEMA.<h2>';
                    echo'<article class="full-box tile">
                    <div class="full-box tile-title text-center text-titles text-uppercase">
                    FORMATO DE CALIFICACIONES
                    </div>
