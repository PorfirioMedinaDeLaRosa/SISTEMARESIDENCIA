...
$idproyecto = $datosP['idproyecto'];
    ...
    <div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
            <h4>Tercer reporte</h4>
            <h5>Subir un archivo PDF por nombre su número de control más la terminación R3</h5>
            <h5>Ejemplo 20CS0001R3</h5>
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "AreporteA3.php",        // Url to which the request is send
