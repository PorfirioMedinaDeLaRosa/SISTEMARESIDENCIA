...
AND tb_residentes.no_control=asignacionproyecto.no_control AND proyectos.idproyecto = numerodeasesores.IdAS4     
                AND asesor.IdAS = numerodeasesores.IdAS   AND asignacionempresa.no_controle =empresa.no_control AND   tb_residentes.no_control = asignacionempresa.no_control  AND tb_residentes.periodo = 'AGO-DIC 2022'";
	...
	if($resultado->num_rows > 0 ){
		...
		$objPHPExcel->setActiveSheetIndex(0)
					...
					->setCellValue('AM2',  $titulosColumnas[37]);
