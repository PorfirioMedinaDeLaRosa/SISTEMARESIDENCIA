...
include'navram.php';
    ...
    <div class="container-fluid">
      <div class="page-header">
        <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i>Proyecto <small>Finalización de Proyecto</small></h1>
       <form>
       <h2>El Proceso de registro de residencia profesional ha finalizado</h2>
           <p class="text-center">    
                                        <button class="" >
                                        <a href="menusolicitud.php"><i class=""></i>Inicio</a>
                                        </button>
