  ...
  <div class="row">
    ...
    <div class="panel panel-primary">
      <div class="panel-heading">
        <h3 class="panel-title">Cargar Carta de aceptación</h3>
      </div>
      <div class="panel-body">
        <div class="col-lg-6">
		<h4>Formato carta de aceptación</h4>
            <h5>Subir un archivo PDF por nombre su número de control más la terminación FCA</h5>
            <h5>Ejemplo 20CS0001FCA</h5>
			<h5>Nota: Para verificar que el archivo ha subido correctamente, observar la tabla de la parte de abajo y verificar 
                que se encuentre el registro con el nombre del  archivo que acaba de subir, o dirigirse al paso 15, sección gestión tecnológica 
                y de igual manera podrá observar el documento subido.
</h5>
          <form method="POST" action="FCartaC.php" enctype="multipart/form-data">
<div class="">
          ...
          <button class="" type="submit">Cargar carta</button>
          </form>
        </div>
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "FCartaC.php",        // Url to which the request is send
