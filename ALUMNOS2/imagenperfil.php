...
<?php  }} ?>
		...
		<div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
			...
			<h5>Subir un archivo jpg o  png,  llevar por nombre su número de control.</h5>
            <h5>Ejemplo 20CS0001</h5>
	<form >
...
<input type="submit"  name="submitt" id="submitt" class="btn btn-info btn-raised btn-sm" value="Anterior paso" />
		...
		<form   action="serviciosocialregistro.php">
       <div style="text-align:center;">
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "subirimagenalumno.php",        // Url to which the request is send
