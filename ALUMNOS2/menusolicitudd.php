		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i> Users <small><?php echo 
					$datos['nombre']." ".$datos['ap']." ".$datos['am']; ?></small></h1>
			</div>
...
$q = $mysqli->query( "     SELECT * FROM asignacionproyecto WHERE no_control = '$idGT'      ");
...
HTML;
	...
	echo "<div id=\"absolut\"><a class='btn btn-info btn-raised btn-sm' href='periodo.php '><span class='glyphicon glyphicon-actualizar'></span>Nuevo Proyecto</a></>"; 	
                ...
                <th class="text-center" >Nombre Completo </th>
                 ...
                 <th width="80" class="text-center" >Carrera</th>
                    ...
                    <th class="text-center" >Status Solicitud</th>
                     ...
                     <th class="text-center" >Iniciar Residencia</th>
