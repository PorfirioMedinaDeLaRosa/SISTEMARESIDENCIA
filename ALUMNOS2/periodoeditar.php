...
<form  name="add_name" id="add_name" method="POST">
			     ...
			     <div class="form-group label-floating">
			       ...
			       <div class="form-group label-floating">
					...
					<div class="form-group label-floating">
											...
											<div class="form-group label-floating">
											  ...
											  <input maxlength="20" onkeyup="validar()"  class="form-control" id="semestrea" name="semestrea" type="number" value="<?php echo $datos['semestre']; ?>" >
											</div>
											...
											<div class="form-group label-floating">
											  ...
											  <input  maxlength="30" onkeyup="validar()" class="form-control" type="text" id="folioa" name="folioa" value="<?php echo $datos['folios']; ?>">
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Email:</label>
											  <input   maxlength="90" onkeyup="validar()" class="form-control" type="Email" id="emaila" name="emaila" value="<?php echo $datos['email']; ?>">
											   <span id="emailOK"></span>
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Avenida o Calle:</label>
											  <input  maxlength="90" onkeyup="validar()" class="form-control" type="text" id="callea" name="callea" value="<?php echo $datos['calle']; ?>">
											</div>

											<div class="form-group label-floating">
											  <label for="email">Número Exterior:</label>
											  <input  maxlength="10"  onkeyup="validar()" class="form-control" id="numeroea" name="numeroea" type="number" value="<?php echo $datos['noe']; ?>" >
											</div>
											<div class="form-group label-floating">
											  <label for="email">Número Interior:</label>
											  <input  maxlength="10" onkeyup="validar()" class="form-control" id="numeroia" name="numeroia" type="number" value="<?php echo $datos['noi']; ?>" >
											</div>
											<div class="form-group label-floating">
											...
											<div class="form-group label-floating">
											  ...
											  <input  maxlength="90" onkeyup="validar()" class="form-control" type="text" id="municipioa" name="municipioa" value="<?php echo $datos['municipio']; ?>">
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Estado:</label>
											  <input  maxlength="50" onkeyup="validar()" class="form-control" type="text" id="estadoa" name="estadoa" value="<?php echo $datos['estado']; ?>">
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Teléfono:</label>
											  <input  maxlength="15" onkeyup="validar()"class="form-control" type="tel" id="telefonoa" name="telefonoa" value="<?php echo $datos['telefono']; ?>">
		      	...
		      	<p class="text-center">
                                        ...
                                        <a href="datosempresaeditar.php"><i class=""></i>Paso 2</a>
                                        </button>
                                        </p>
