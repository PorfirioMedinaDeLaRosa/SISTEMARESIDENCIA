    ...
    <div class="container-fluid">
      <div class="page-header">
       ...
       <div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
          ...
          <div>
            <label>Para asignar el periodo de residencia profesional, debe de verificar el inicio de la primera actividad, y el final de la ultima actividad</label>
            <input type="text" class="form-control" name="periodop" id="periodop" placeholder="12/Enero/2017-30/Agosto/2017"></input>
      ...
      <br><br>
       ...
       <input type="button" name="submit" id="submit" class="btn btn-info btn-raised btn-sm" value="Registar" />
         ...
         <p class="text-center">    
                                        ...
                                        <a href="final.php"><i class=""></i>Siguiente</a>
                                        </button>
                                        </p>         
            </div>
    </div>
  ...
  <script type="text/javascript">
    $(document).ready(function(){  
      ...
      $('#submit').click(function(){            
           $.ajax({  
                url:"../Actualizacion2/registroperiodo.php",  
                method:"POST",  
