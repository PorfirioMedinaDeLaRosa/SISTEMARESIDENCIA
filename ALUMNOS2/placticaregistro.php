...
$idproyecto = $datosP['idproyecto'];
    ...
    <div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
            <h4>Constancia de participación</h4>
            <h5>Subir un archivo PDF por nombre, su número de control más la terminación PP</h5>
            <h5>Ejemplo 20CS0001PP</h5>
             <div class="modal-body">
            <form >
              <input  id="no_control" name="no_control" type="text"  value="<?php echo strtoupper($_SESSION["no_control"]); ?>">
...
AND tb_residentes.no_control='$idGT'";
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "PlacticaRR.php",        // Url to which the request is send
