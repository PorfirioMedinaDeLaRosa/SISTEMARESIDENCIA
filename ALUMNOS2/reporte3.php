      ...
      <div class="page-header">
        ...
        <?php                          
                $idproyecto = $_GET['idproyecto'];
                       ...
                       echo "<a class='btn btn-info btn-raised btn-sm' href='operaciones.php? idproyecto=" .$idproyecto."    '><span class='glyphicon glyphicon-actualizar'></span>REGRESAR</a>";
            ...
            ?>
              ...
              <?php 
                ...
                $idproyecto = $_GET['idproyecto'];
                       ...
                       echo "<a class='btn btn-info btn-raised btn-sm' href='reportefinal.php? idproyecto=" .$idproyecto."    '><span class='glyphicon glyphicon-actualizar'></span>Reporte 2 </a>";
            ...
            ?>
              ...
              <?php 
                ...
                $idproyecto = $_GET['idproyecto'];
                       ...
                       echo "<a class='btn btn-info btn-raised btn-sm' href='reportefinal.php? idproyecto=" .$idproyecto."    '><span class='glyphicon glyphicon-actualizar'></span>Reporte Final</a>";
...
<?php
       ...
       $sql = "SELECT  *  FROM   reportesasesor, tb_residentes
                WHERE reportesasesor.no_control = tb_residentes.no_control AND tb_residentes.no_control='$idGT'
                 ";
           $query = $db->execute($sql);
            while($datos=$db->fetch_row($query)){?>
            <tr>
