    ...
    <div class="container-fluid">
      <div class="page-header">
       ...
       <div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
            ...
            <h4>Recuerden que si eligen el número de semanas, se aumenta dos más, en el  sistema por el informe técnico</h4>
          ...
          $datos12['idproyecto']; ?>"><br>

<label>Semanas de actividades</label>
      <select   class="form" id="semanas" name="semanas">
        <option><?php echo 
          $datos12['semanas']; ?></option>
                              <option>14</option>
                              <option>15</option>
                              <option>16</option>
                              <option>17</option>
...
<label>+2 Semanas del informe técnico</label><br>

     
<input disabled="" type="text" name="" id="" value="<?php if($datos12['semanas']=='') echo 'No hay semanas '; else   echo 
          $datos12['semanas']+2; ?>">Total de Semanas
...
<input type="submit"  name="submitt" id="submitt" class="btn btn-info btn-raised btn-sm" value="Siguiente paso" />
  ...
  $('#submit').click(function() {            
    $.ajax({  
      url: "../Actualizacion2/semanas.php?rand=" + new Date().getTime(),  
      method: "POST",  
