...
$idproyecto = $datosP['idproyecto'];
    ...
    <div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
            <h4>Constancia de servicio social</h4>
            <h5>Subir un archivo PDF por nombre, su número de control más la terminación SS</h5>
            <h5>Ejemplo 20CS0001SS</h5>
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "serviciosocialRR.php",        // Url to which the request is send
