          ...
          <div id="myTabContent" class="tab-content">
              ...
              <div class="table-responsive">
                <table class="table table-hover text-center">
                  ...
                  <th class="text-center" >Carga Académica </th>
...
<?php
       ...
       $sql = "SELECT  *  FROM   solicitud
           ...
           $query = $db->execute($sql);
            ...
            <td><a href="archivosservicioCarga.php?id=<?php echo strtoupper($datos['no_control'])?>" >Descargar</a></td>   
            
              <td><a href="archivosservicio.php?id=<?php echo strtoupper($datos['no_control'])?>" ><?php echo $datos['nombre_archivoS']; ?></a></td>   
                <td><a href="archivosolicitud.php?id=<?php echo strtoupper($datos['no_control'])?>" ><?php echo $datos['nombre_archivoSS']; ?></a></td>
                 <td><a href="archivosanteproyecto.php?id=<?php echo strtoupper($datos['no_control'])?>" ><?php echo $datos['nombre_archivoA']; ?></a></td>
