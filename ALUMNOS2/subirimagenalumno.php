...
$target_dir = "../ALUMNOS2/imagenperfil/";
$carpeta=$target_dir;
...
// Check file size
if ($_FILES["fileToUpload"]["size"] > 14084900) {
...
// if everything is ok, try to upload file
    ...
    $sql = "UPDATE tb_residentes SET ruta_imagen = '$nombre', paso3='x' where no_control = '$idGT' ";
    $result = $mysqli->query($sql); 
    
    $no_control = '../ALUMNOS2/'.strtoupper($idGT);
