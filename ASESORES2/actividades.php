      ...
      <div class="row">
        <div class="col-xs-12">
          <ul class="nav nav-tabs" style="margin-bottom: 15px;">
              <li> <a class="active" href="#list"  data-toggle="tab">Alumnos</a></li>
...
AND tb_residentes.no_control=asignacionproyecto.no_control  AND proyectos.idproyecto = numerodeasesores.IdAS4 AND numerodeasesores.IdAS = asesor.IdAS   AND  asesor.IdAS='$idGT' and tb_residentes.periodo='$keywords'";
     ...
     // while($datos=$db->fetch_row($query))
         while($datos=$db->fetch_row($query)){?>
            ...
            <tr>
              ...
              echo "<a class='btn btn-danger btn-raised btn-xs' target='_blank'  href='diagrama.php?no_control=".$datos['no_control']."    '  ><span class='glyphicon glyphicon-actualizar'></span>Diagrama de actividades</a>";


   echo "<a class='btn btn-danger btn-raised btn-xs' target='_blank'  href='../ALUMNOS2/anteproyecto.php?no_control=".$datos['no_control']." &  periodo=" .$datos['periodo'] ." &  semanas=" .$datos['semanas'] ."  '  ><span class='glyphicon glyphicon-actualizar'></span>Anteproyecto</a>";
