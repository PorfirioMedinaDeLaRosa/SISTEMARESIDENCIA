...
if (isset($_POST['search'])) {
    ...
    $carrera = $_POST['contrasena'];
       

      
     
      
       $sql = "SELECT asesor.IdAS,  tb_residentes.no_control,tb_residentes.periodo,  tb_residentes.nombre , tb_residentes.am , tb_residentes.ap, tb_residentes.carrera,     reportesasesor.no_control,    reportesasesor.IdAS, reportesasesor.calificacionR1, reportesasesor.nombre_archivoR1, reportesasesor.statusR1,  reportesasesor.modificacionesR1
       FROM tb_residentes, reportesasesor, asesor 
       WHERE tb_residentes.no_control = reportesasesor.no_control  and asesor.IdAS = reportesasesor.IdAS   and  tb_residentes.periodo = '$keywords' and tb_residentes.carrera = '$carrera' 
                 "  ;
           $query = $db->execute($sql);
            while($datos=$db->fetch_row($query)){?>
            <tr>
...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT  tb_residentes.no_control,tb_residentes.periodo,  tb_residentes.nombre , tb_residentes.am , tb_residentes.ap, tb_residentes.carrera,     reportesasesor.no_control,    reportesasesor.IdAS, reportesasesor.calificacionR2, reportesasesor.nombre_archivoR2, reportesasesor.statusR2,  reportesasesor.modificacionesR2
    FROM tb_residentes, reportesasesor
    WHERE tb_residentes.no_control = reportesasesor.no_control and tb_residentes.periodo = '$keywords' and tb_residentes.carrera = '$carrera'";
...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT  tb_residentes.no_control,tb_residentes.periodo,  tb_residentes.nombre , tb_residentes.am , tb_residentes.ap, tb_residentes.carrera,     reportesasesor.no_control,    reportesasesor.IdAS, reportesasesor.calificacionR3, reportesasesor.nombre_archivoR3, reportesasesor.statusR3,  reportesasesor.modificacionesR3
    FROM tb_residentes, reportesasesor
    WHERE tb_residentes.no_control = reportesasesor.no_control and tb_residentes.periodo = '$keywords' and tb_residentes.carrera = '$carrera'";
...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT  tb_residentes.no_control,tb_residentes.periodo,  tb_residentes.nombre , tb_residentes.am , tb_residentes.ap, tb_residentes.carrera,     reportesasesor.no_control,    reportesasesor.IdAS, reportesasesor.calificacionRF , reportesasesor.nombre_archivoRF, reportesasesor.statuss,  reportesasesor.modificaciones
    FROM tb_residentes, reportesasesor
    WHERE tb_residentes.no_control = reportesasesor.no_control and tb_residentes.periodo = '$keywords' and tb_residentes.carrera = '$carrera'";
...
if (isset($_POST['search'])) {
    ...
    $sql = "SELECT  tb_residentes.no_control,tb_residentes.periodo,  tb_residentes.nombre , tb_residentes.am , tb_residentes.ap, tb_residentes.carrera,     reportesasesor.no_control,    reportesasesor.IdAS, reportesasesor.calificacionRFF , reportesasesor.nombre_archivoRFF, reportesasesor.statussFF,  reportesasesor.modificacionesFF
    FROM tb_residentes, reportesasesor
    WHERE tb_residentes.no_control = reportesasesor.no_control and tb_residentes.periodo = '$keywords' and tb_residentes.carrera = '$carrera'";
