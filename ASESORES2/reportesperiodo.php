...
include'navram.php';
		...
		<div style="width: 500px;margin: auto;border: 1px solid blue;padding: 30px;">
		 ...
		 <form action="menureporte1.php" method="POST" onSubmit="return validarForm(this)"> 
...
<input type="text" name="contrasena" id="contrasena" value="<?php echo $datos['CarreraAS']; ?>" hidden=""   >   
