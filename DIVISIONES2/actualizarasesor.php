...
include'navram.php';
		...
		<div class="container-fluid" id="menu2" >
			<div class="page-header">
			  <h1 class="text-titles"><i class=""></i> <small>Actualizar  Asesor</small></h1>
			</div>
			</div>
			<?php 
...
$IdAS = $_GET['id'];
            ...
            $sqlA = "SELECT  *  FROM  asesor WHERE IdAS = '$IdAS'
                 ";
 ...
 ?>	
								...
								<div class="row">
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form name="add_name" id="add_name" method="POST">
									    	...
									    	<input  id="IdAS" name="IdAS" type="hidden"  value="<?php echo $datosA['IdAS']; ?>"></input>  

									    	<div class="form-group label-floating">
			      
											  <label for="nombre">Nombre:</label>
											  <input   class="form-control" type="text" id="nombrea" name="nombrea"  maxlength="90" value="<?php echo $datosA['NombreAS']; ?>"  >
					</div>
											<div class="form-group">
										      <label class="control-label">Carrera</label>
										        <select   class="form-control" id="carreraa" name="carreraa"  maxlength="90" value="<?php echo $datosA['CarreraAS']; ?>">
										          <option><?php echo $datosA['CarreraAS']; ?></option>
										          <?php
        ...
        ?>
											...
											<div class="form-group label-floating">
											  ...
											  <input  onkeyup="validar()" maxlength="90" class="form-control" id="emaila" name="emaila" type="Email"  value="<?php echo $datosA['EmailAS']; ?>">
											    <span id="emailOK"></span><br>
											</div>

											<div class="form-group label-floating">
											  <label class="control-label">Telefono</label>
											  <input   class="form-control" type="text" id="telefonoa" name="telefonoa" maxlength="15"  value="<?php echo $datosA['TelefonoAS']; ?>">
											</div>
											
											<div class="form-group label-floating">
											  <label class="control-label">Password</label>
											  <input   class="form-control" maxlength="40"  id="passworda" name="passworda" type="text"  value="<?php echo $texto_original; ?>">
											</div>
...
function eliminarDato(IdAS){
   ...
   ajax.open("GET", "../Eliminacion2/eliminaAAA.php?id="+IdAS);
