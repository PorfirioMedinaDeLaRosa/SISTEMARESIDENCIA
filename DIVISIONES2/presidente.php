...
<?php  }} ?>	
		<div class="container-fluid" id="menu2" >
			<div class="page-header">
			  <h1 class="text-titles"><i class=""></i> <small>Registro de Presidente de Academia</small></h1>
			</div>
			</div>
			...
			<div class="row">
				<div class="col-xs-12">
					<ul class="nav nav-tabs" style="margin-bottom: 15px;">
					  	...
					  	<li><a href="#list2" data-toggle="tab">List</a></li>
					</ul>
									...
									<div class="col-xs-12 col-md-10 col-md-offset-1">
									    <form name="add_name" id="add_name" method="POST">
									    	...
									    	<div class="form-group label-floating">
											  ...
											  <input   class="form-control" maxlength="50" type="text" id="nombrea" name="nombrea"   >
					</div>
										    ...
										    <div class="form-group">
										      <label class="control-label">Carrera</label>
										        <select   class="form-control" maxlength="50" id="carreraa" name="carreraa">
        ...
        ?>
											...
											<div class="form-group label-floating">
											  ...
											  <input  onkeyup="validar()"  maxlength="50" class="form-control" id="emaila" name="emaila" type="Email">
 ...
 $(document).ready(function(){  
     $('#list2').load('list2.php');
      ...
      $('#submit').click(function(){            
           $.ajax({  
                url:"../Registro2/insertarpresidente.php",  
                method:"POST",  
...
$(document).ready(function() {    
 ...
 $('#emaila').blur(function(){
        ...
        $.ajax({
            type: "POST",
            url: "check_username_availablity3.php",
            data: dataString,
            success: function(data) {
...
function eliminarDato2(idP){

    if(confirm("¿DESEA ELIMINAR ESTE USUARIO? ESTA ACCIÓN NO SE PUEDE DESHACER")){

        $.ajax({
            url: "../Eliminacion2/eliminapresidente.php",
            type: "GET",
            data: { id: idP },
