...
<div class="upload-container">
  <h4>Evaluación 3</h4>
  <h5>Sube un archivo PDF nombrado con tu número de control más la terminación <strong>E3</strong></h5>
  <h5>Ejemplo: <code>20CS0001E3.pdf</code></h5>
...
function upload_image() {
    ...
    $.ajax({
        url: "../Registro2/reportefinal.php",
        type: "POST",
        data: data,
        contentType: false,
        processData: false,
