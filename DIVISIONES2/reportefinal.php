...
<div class="upload-container">
  ...
  <h5>Sube un archivo PDF nombrado con tu número de control más la terminación <strong>EF</strong></h5>
  <h5>Ejemplo: <code>20CS0001EF.pdf</code></h5>

  <form>
    <!-- Campo visible del número de control -->
    <input type="hidden" id="no_control" name="no_control" value="<?php echo $_SESSION['user_id']; ?>" readonly>

    <label for="fileToUpload">Subir archivo PDF</label>
    <input type="file" id="fileToUpload" accept=".pdf" onchange="upload_image2();">

    <p class="help-block">Selecciona un archivo PDF válido.</p>
    <div class="upload-msg2"></div> <!-- Aquí se mostrará el mensaje AJAX -->
  </form>
</div>
...
<script>
	function upload_image(){//Funcion encargada de enviar el archivo via AJAX
				...
				$.ajax({
					url: "../Registro2/reporteuno.php",        // Url to which the request is send
