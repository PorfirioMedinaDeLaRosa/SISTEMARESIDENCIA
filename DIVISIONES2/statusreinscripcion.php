...
include'navram.php';
		...
		<div class="container-fluid" id="menu2" >
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-account zmdi-hc-fw"></i><small>Alumnos</small></h1>
			   <?php 
...
<?php  }} ?>
<div style="width: 300px;margin: auto;border: 1px solid blue;padding: 30px;">
	<h3>Carga Académica</h3>
           
			   <form action="alumnossolicitudes.php" method="POST" onSubmit="return validarForm(this)"> 
...
<?php 
$IDR = $_GET['no_control'];
            $sqlR = "SELECT  *  FROM  reinscripionalumnos
                WHERE no_control ='$IDR' 
                 ";
...
<?php  }} ?>
            ...
            <iframe name="visor" width="1050" height="450" src="PRECARGAS/<?php echo $datosR['nombre_archivoRE']; ?>"></iframe>
