		...
		<section class="full-width header-well">
			...
			<div class="full-width header-well-text">
				<p class="text-condensedLight">
					SOLICITUDES DE RESIDENCIA PROFESIONAL
				</p>
			</div>
		</section>
...
$sql = "  SELECT * FROM alumnos WHERE IDSemestre ='$keywords'  AND  IDCarrera='$carrera' ";
    ...
    if( mysqli_num_rows($query)  > 0) {
     ...
     // while($datos=$db->fetch_row($query))
         while($datos=$db->fetch_row($query)){?>
            ...
            <td><?php 
                       echo "<a class='btn btn-danger btn-raised btn-xs' href='editaralumno.php? id=" .$datos['Ncontrol'] ."  &  idproyecto=" .$datos['Ncontrol'] ."  '><span class='glyphicon glyphicon-actualizar'></span>Editar</a><br>";
					   echo "<a class='btn btn-danger btn-raised btn-xs' href='eliminaralumno.php? id=" .$datos['Ncontrol'] ." &  idp=" .$datos['IDAlumno'] ."  '><span class='glyphicon glyphicon-actualizar'></span>Eliminar</a><br>";
            ...
            ?></td> 
             <td><figure class="full-box"><img  src="../ALUMNO/ALUMNO/ALUMNOSDOCUMENTOS/<?php echo $datos['IDAlumno']; ?>/<?php echo $datos['imagenperfil']; ?>"  width="80" /></figure></td>
                 ...
                 <td><?php echo $datos['CurpAlumno']; ?></td>
                 <td><?php echo $datos['SemestreAlumno']; ?></td>
                 <td><?php echo $datos['EmailPersonal']; ?></td>
                 <td><?php echo $datos['EmailIns']; ?></td>
                 <td><?php echo $datos['TelefonoAlumno']; ?></td>
