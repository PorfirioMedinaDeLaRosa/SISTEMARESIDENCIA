       ...
       $sql = "SELECT  *  FROM    tramitesgestion
           ...
           $query = $db->execute($sql);
            ...
            <td><?php echo $datos['no_control']; ?></td>
             <td><a href="../GESTION2/acuerdos.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoAC']; ?></a></td>
                 <td><a href="../GESTION2/cpresentacion.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoCP']; ?></a></td>
                 <td><a href="../GESTION2/caceptacion.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoCA']; ?></a></td>
                  <td><a href="../GESTION2/cliberacion.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoCL']; ?></a></td>
