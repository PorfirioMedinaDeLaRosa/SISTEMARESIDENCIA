...
$seccion->addImage("encabezadoo.png", [
   ...
   //llllllllllllllll
$seccion->addText("OFICIO: D.R.P.yS.S. (NÚMERO DE OFICIO) /2025", array('name' => 'Helvetica', 'size' =>10, 'bold' => TRUE, 'lineHeight' => 0.8),array('align' => 'right'));
...
while($row222=mysqli_fetch_array($rec2))
{
    ...
    $seccion->addText("Correo electrónico: ".$row222['EmailAS'], array('name' => 'Arial', 'size' =>11, 'bold' => FALSE, 'lineHeight' => 1),array('align' => 'justified'));
