		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
			      ...
			      <input  id="idGT" name="idGT" type="hidden"  value="<?php echo $datos['idGT']; ?>"></input> 
			     <div class="form-group label-floating">
			      
											  <label for="nombre">Nombre:</label>
											  <input  onkeyup="validar()" maxlength="100" class="form-control" type="text" id="nombregt" name="nombregt" value="<?php echo $datos['NombreGT']; ?>" >
					</div>  
			       <div class="form-group label-floating">
			      
											  <label for="nombre">Cargo:</label>
											  <input  onkeyup="validar()" class="form-control" type="text" id="cargogt" name="cargogt" maxlength="200" value="<?php echo $datos['CargoGT']; ?>">
					</div>
											...
											<div class="form-group label-floating">
											  ...
											  <input onkeyup="validar()" maxlength="100" class="form-control" id="emailgt" name="emailgt" type="Email" value="<?php echo $datos['CorreoGT']; ?>" >
											  <span id="emailOK"></span><br>
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Teléfono:</label>
											  <input onkeyup="validar()" class="form-control" type="text" id="telefonogt" maxlength="15" name="telefonogt" value="<?php echo $datos['TelefonoGT']; ?>" >
											  <span id="telefonoOK"></span>
											</div>
											
											<div class="form-group label-floating">
											  <label for="password">Password:</label>
									<input onkeyup="validar()" maxlength="40"  class="form-control"  id="passwordgt" name="passwordgt" type="Password" value="<?php echo $datos['PasswordGT']; ?>">
											</div>
			    </div>
		      	<p class="text-center">
...
<script>
 ...
 $(document).ready(function(){  
      ...
      $('#submit').click(function(){            
           $.ajax({  
                url:"../Actualizacion2/actualizarGT.php",  
                method:"POST",  
