...
if (isset($_POST['subir'])) {
   ...
   $sql = "INSERT INTO documentosgestion(tamanio,tipo,nombre_archivo, no_control) VALUES('$tamanio','$tipo','$nombre', '$no_control')";
...
$sql = " UPDATE  documentosgestion SET      tamanio=' $tamanio'  ,   tipo=' $tipo' ,  nombre_archivo = '$nombre'   where no_control='$no_control'";         
