   ...
   $carrera = $_POST['carrera'];
    //Conectamos con la base de datos en la que vamos a buscar
     ...
     //   $db->query('set name utf8');
            ...
            $sql = "SELECT  *  FROM  asignacionactividades
    ...
    if( mysqli_num_rows($query)  > 0) {
         ...
         while($datos=$db->fetch_row($query)){?>
            ...
            <tr >
                ...
                <td><?php echo "<a class='btn btn-danger btn-raised btn-xs' ><span class='glyphicon glyphicon-actualizar'></span>Eliminar registro</a>";
...
height: 200px; /*establece la altura máxima, lo que no entre quedará por debajo y saldra la barra de scroll*/
                ...
                <td><div  style="overflow: auto"><?php echo $datos['id']; ?></div></td>
               
                <td><?php echo $datos['no_controla']; ?></td>
