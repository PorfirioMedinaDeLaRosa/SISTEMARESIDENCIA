...
include'navram.php';
		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles"><i class=""></i><small>Carreras</small></h1>
			...
			<div class="row">
				<div class="col-xs-12">
			       ...
			       <div class="form-group label-floating">
											  ...
											  <input onkeyup="validar()" maxlength="90"  class="form-control" type="text" id="nombre" name="nombre"   >
					</div>
...
<script> 
 ...
 $(document).ready(function(){  
      $('#list').load('listcarreras.php');
        
      $('#submit').click(function(){            
           $.ajax({  
                url:"../Registro2/registrocarrera.php",  
                method:"POST",  
...
function eliminacarrera(idcarrera){
   ...
   $(document).ready(function() {
            ...
            // Recargo la página
            location.reload("listcarreras.php");
   ...
   ajax.open("GET", "../Eliminacion2/eliminacarrera.php?id="+idcarrera);
