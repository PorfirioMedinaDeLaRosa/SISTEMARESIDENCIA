...
include'navram.php';
		...
		<div class="container-fluid">
			<div class="page-header">
				 <h1 class="text-titles"><i class=""></i> <small>Proyectos dados de baja </small></h1>
			 
			 <form action="buscarproyectos.php" method="POST" onSubmit="return validarForm(this)"> 
...
<input type="submit" name="search" id="search" value="Buscar" disabled="">
</form>
			</div>
