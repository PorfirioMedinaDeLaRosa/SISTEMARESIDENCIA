   ...
   $periodo = $_POST['keywords'];
    //Conectamos con la base de datos en la que vamos a buscar
     ...
     //   $db->query('set name utf8');
            ...
            $sql = "SELECT  *  FROM  tb_residentes, archivosbajaproyecto
                WHERE  tb_residentes.no_control = archivosbajaproyecto.no_control AND  carrera LIKE '%" . $carrera . "%' AND periodo LIKE '%" . $periodo . "%'   
                 ";
            $query = $db->execute($sql);
     ...
     // while($datos=$db->fetch_row($query))
         while($datos=$db->fetch_row($query)){?>
            ...
            <tr>
               ...
               <td><a href="proyectosbaja.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivo']; ?></a></td>
...
<?php  }}} ?>
  <button class="btn btn-warning" >
                                        <a href="IINPB.php"><i class=""></i>Nueva Consulta</a>
                                        </button>
