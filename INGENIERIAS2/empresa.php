...
<input   style="height:50" size="70" maxlength="70" type="text" name="observaciono" id="observaciono" <?php echo $datos['statuso'] == "Aceptar" ||  $datos['statuso'] == ""  ? ' disabled="disabled"' : '';?>   value="<?php echo $datos['observaciono']; ?>"  /><br />
          ...
          <div class="form-group label-floating">
                        ...
                        <input   class="form-control" type="text" id="apa" name="apa" value="<?php echo $datos['periodop']."".$datos['fechatermino']; ?>">
          </div>
<label for="">Opciones:</label>
       ...
       $sql = "SELECT  *  FROM  actividades , asignacionactividades
           ...
           $query = $db->execute($sql);
            ...
            <td><?php echo $datos['semanas']; ?></td>
                ...
                <td><?php   echo "<a class='btn btn-danger btn-raised btn-xs' href='../Eliminacion/eliminaactividad4.php? id=".$datos['idactividad']."'><span class='glyphicon glyphicon-actualizar'></span>Eliminar</a>"; ?></td>
       ...
       $sql2 = "SELECT  *  FROM  asesor, numerodeasesores, proyectos
           ...
           $query = $db->execute($sql2);
            ...
            <td><?php echo $datos['CarreraAS']; ?></td>
             ...
             <td><?php 
                       echo "<a class='btn btn-danger btn-raised btn-xs' href='../Eliminacion2/eliminaasesor.php? id=" .$datos['id'] ."    '><span class='glyphicon glyphicon-actualizar'></span>Eliminar Asesor</a>";

                      
 
echo "<a  target_black class='btn btn-danger btn-raised btn-xs' href='actualizarasesor.php? id=" .$datos['id'] ."    '><span class='glyphicon glyphicon-actualizar'></span>Actualizar Asesor</a>";
...
<label>Status General</label>
  <input disabled=""  type="text-center" class="form-control" id="actividades" name="actividades" value="<?php echo $datos2['StatusGeneral']; ?>"></>
            ...
            <p class="text-center">
                          <button href="#!" disabled="" type="button" name="submitt" id="submitt" class="btn btn-info btn-raised btn-sm"><i class="zmdi zmdi-floppy"></i> Save</button>
                        </p>
                        <br>
                                            <br>
