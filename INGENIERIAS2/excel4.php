<?php
    ...
    //Recogemos las claves enviadas
	 ...
	 $consulta = "SELECT *  FROM objetivos, asignacion WHERE asignacion.NControlAdmin = objetivos.NControl   ORDER BY objetivos.IDObjetivo";
	...
	if($resultado->num_rows > 0 ){
		...
		$tituloReporte = "ALUMNOS SERVICIO SOCIAL";
		$titulosColumnas = array('NO_CONTROL', 'NOMBRE');
		...
		$objPHPExcel->getActiveSheet()->setSharedStyle($estiloInformacion, "A3:B".($i-1));
