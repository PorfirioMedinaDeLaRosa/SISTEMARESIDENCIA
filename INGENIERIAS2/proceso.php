...
include'navram.php';
		...
		<div class="container-fluid">
			<div class="page-header">
				<h1 class="text-titles"><i class=""></i> <small>Solicitud de Residencia Profesional</small></h1>
			  
			 <form action="solicitudresidencia.php"  method="POST" onSubmit="return validarForm(this)"> 
