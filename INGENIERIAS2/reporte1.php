    ...
    <div class="container-fluid">
      <div class="page-header">
        ...
        <button class="btn btn-warning" >
                                        <a href="procesor1.php"><i class=""></i>Nueva Consulta</a>
                                        </button>
...
if (isset($_POST['search'])) {
    ...
    $keywords = $_POST['keywords'];
       ...
       $sql = "SELECT  *  FROM  tb_residentes,  reportesasesor, asignacionproyecto
                WHERE  carrera LIKE '%" . $carrera . "%'   AND  periodo LIKE '%" . $keywords . "%' AND tb_residentes.no_control = asignacionproyecto.no_control  AND tb_residentes.no_control= reportesasesor.no_control 
                 ";
           $query = $db->execute($sql);
        ...
        echo '<h4>Alumnos '.$count_results.' resultados.</h4>';
            ...
            <td><?php echo $datos['no_control']; ?></td>
                ...
                <td><a href="../ASESORES2/archivosreporteuno.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoR1']; ?></a></td>   
                 ...
                 <td><?php echo "<a data-toggle='modal' data-target='#Dialog-A' data-no_control='" .$datos['no_control'] ."'  data-status='" .$datos['statusR1'] ."' data-modificaciones='" .$datos['modificacionesR1'] ."' 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <form action="../Actualizacion2/actualizarreporte1.php"  method="POST">
