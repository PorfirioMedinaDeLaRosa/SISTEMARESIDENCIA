...
include'navram.php';
    ...
    <div class="container-fluid">
      <div class="page-header">
        <h1 class="text-titles"><i class=""></i> <small>Evaluación Número 2</small></h1>
        <br>
        <button class="btn btn-warning" >
                                        <a href="procesor2.php"><i class=""></i>Nueva Consulta</a>
                                        </button>
        ...
        echo '<h4>Alumnos '.$count_results.' resultados.</h4>';
            ...
            <td><?php echo $datos['no_control']; ?></td>
                ...
                <td><a href="../ASESORES2/archivosreportedos.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoR2']; ?></a></td>   
                 ...
                 <td><?php echo "<a data-toggle='modal' data-target='#Dialog-A' data-no_control='" .$datos['no_control'] ."'  data-status='" .$datos['statusR2'] ."'  data-modificaciones='" .$datos['modificacionesR2'] ."' 
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <form action="../Actualizacion2/actualizarreporte2.php"  method="POST">
