                  ...
                  <div class="full-box dashboard-sideBar-UserInfo">
                    <div align="center"><img  src="imagenperfil/<?php echo $datos['ruta_imagen']; ?>" alt="" width="150" /></div><br><br>
                        <figure class="full-box">
                              ...
                              <figcaption class="text-center text-titles"><?php echo $datos['NCompletoA']."  ".$datos['CargoA']; ?></figcaption>
                        </figure>
...
include'navram.php';
    ...
    <div class="container-fluid">
      <div class="page-header">
        <h1 class="text-titles"><i class=""></i> <small>Evaluación Final</small></h1>
       
        <button class="btn btn-warning" >
                                        <a href="procesorfinal.php"><i class=""></i>Nueva Consulta</a>
                                        </button>
        ...
        <div class="col-xs-12">
          <ul class="nav nav-tabs" style="margin-bottom: 15px;">
              <li> <a href="#list" data-toggle="tab">Alumnos Residentes</a></li>
               <li> <a href="#list2" data-toggle="tab">Formato Final</a></li>
          ...
          <div id="myTabContent" class="tab-content">
              ...
              <div class="table-responsive">
               ...
               <th class="text-center" >Calificación</th>
                <th class="text-center" >Reporte Final</th>
           ...
           $query = $db->execute($sql);
            ...
            <td><?php echo $datos['no_control']; ?></td>
                ...
                <td><a href="../ASESORES2/archivosreportefinal.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoRF']; ?></a></td>   
                 ...
                 <td><?php echo "<a data-toggle='modal' data-target='#Dialog-A' data-no_control='" .$datos['no_control'] ."' data-status='" .$datos['statuss'] ."' data-modificaciones='" .$datos['modificaciones'] ."' 
...
if (isset($_POST['search'])) {
       ...
       $sql = "SELECT  *  FROM  tb_residentes,  reportesasesor
           ...
           $query = $db->execute($sql);
            ...
            <td><?php echo $datos['no_control']; ?></td>
                ...
                <td><a href="../ASESORES2/archivosreportefinalfinal.php?id=<?php echo $datos['no_control']?>" ><?php echo $datos['nombre_archivoRF']; ?></a></td>   
                
                  <td><?php echo $datos['statussFF']; ?></td>
                 <td><?php echo $datos['modificacionesFF']; ?></td>

                 <td><?php echo "<a data-toggle='modal' data-target='#Dialog-AA' data-no_control='" .$datos['no_control'] ."' data-status='" .$datos['statussFF'] ."' data-modificaciones='" .$datos['modificacionesFF'] ."' 
            class='btn btn-success btn-raised btn-xs '><span class='glyphicon glyphicon-pencil'></span>Status</a> ";
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
           <form action="../Actualizacion2/actualizarreportefinal.php"  method="POST">
 ...
 <div class="modal fade" tabindex="-1" role="dialog" id="Dialog-AA">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          ...
          <div class="modal-body">
           <form action="../Actualizacion2/actualizarreportefinalfinal.php"  method="POST">
           <input  id="no_control" name="no_control" type="hidden" ></input>  
          
                      
                      <div class="form-group label-floating">
                        <label for="email">Status:</label>
                       <select  class="form-control" type="text" id="statusFF" name="statusFF">
                       <option>Recibido</option>
                       <option>Aceptado</option>
                        <option>Rechazado</option>
                      ...
                      <div class="form-group label-floating">
                        <label for="email">Modificaciones:</label>
                       <textarea  class="form-control"  name="modificacionesFF" id="modificacionesFF"></textarea>
                      </div>
