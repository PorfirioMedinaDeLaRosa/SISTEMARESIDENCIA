...
if (isset($_POST['subir'])) {
   ...
   $sql = "INSERT INTO solicitud(tamanioA,tipoA,nombre_archivoA, no_control) VALUES('$tamanio','$tipo','$nombre', '$no_control')";
...
$sql = " UPDATE  solicitud SET  tamanioA=' $tamanio'  ,     tipoA=' $tipo' ,  nombre_archivoA= '$nombre'  where no_control='$no_control'";         
