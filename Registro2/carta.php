...
if (isset($_POST['subir'])) {
   ...
   $sql = "INSERT INTO tramitesgestion(tamanioCA,tipoCA,nombre_archivoCA, no_control) VALUES('$tamanio','$tipo','$nombre', '$no_control')";
...
$sql = " UPDATE  tramitesgestion SET  tamanioCA=' $tamanio'  ,    tipoCA=' $tipo' ,  nombre_archivoCA = '$nombre'  where no_control='$no_control'";         
