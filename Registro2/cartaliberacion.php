...
if (isset($_POST['subir'])) {
   ...
   $sql = "INSERT INTO tramitesgestion(tamanioCL,tipoCL,    nombre_archivoCL, no_control) VALUES('$tamanio','$tipo','$nombre', '$no_control')";
...
$sql = " UPDATE  tramitesgestion SET      tamanioCL=' $tamanio'  ,    tipoCL=' $tipo' ,  nombre_archivoCL = '$nombre'  where no_control='$no_control'";         
