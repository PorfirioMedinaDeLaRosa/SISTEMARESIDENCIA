<?php
   ...
   $no_controlo = $_POST['no_controlo']; 
     
      $objectivos = $_POST['objectivos'];
              
      $sql = $mysqli->query("insert into objectivose (nombre, no_control  ) values ( '$objectivos', '$no_controlo' ) ");
...
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_1'");   
...
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_1'");
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_2'");   
...
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_3'");  
...
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_2'");  
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_3'");
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_4'");    
...
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_3'");
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_4'");    
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_5'");   
}
...
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_4'");    
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_5'");   
$sql = $mysqli->query ( " UPDATE  tb_residentes  SET 	paso6='x'  where no_control='$n_6'");   
