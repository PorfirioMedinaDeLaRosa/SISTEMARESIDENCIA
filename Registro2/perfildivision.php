...
?>
			...
			<div class="row">
			    ...
			    <input  id="idD" name="idD" type="hidden"  value="<?php echo $datos['idD']; ?>"></input>  
			       <div class="form-group label-floating">
											  ...
											  <input onkeyup="validar()"  maxlength="90" class="form-control" type="text" id="nombre" name="nombre"  value="<?php echo $datos['NombreD']; ?>" >
					</div>
					<div class="form-group label-floating">
											  <label for="cargo">Cargo:</label>
											  <input  onkeyup="validar()"  maxlength="90" class="form-control" type="text" id="cargo" name="cargo" value="<?php echo $datos['CargoD']; ?>">
											</div>
											<div class="form-group label-floating">
											  <label for="cargo">Carrera:</label>
											   <select  class="form-control" id="carrera" name="carrera" onChange="mostrar(this.value);">
			                                      <option><?php echo $datos['CarreraD']; ?></option>
										          <?php
        ...
        ?>
											...
											<div class="form-group label-floating">
											  ...
											  <input  onkeyup="validar()"  maxlength="90"  class="form-control" id="email" name="email" type="email" value="<?php echo $datos['EmailD']; ?>">
											   <span id="emailOK"></span>
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Teléfono:</label>
											  <input  onkeyup="validar()"  maxlength="15" class="form-control" type="text" id="telefono" name="telefono" value="<?php echo $datos['TelefonoD']; ?>">
											     <span id="telefonoOK"></span>
											</div>
											
											<div class="form-group label-floating">
											  <label for="password">Password:</label>
											  <input onkeyup="validar()"  maxlength="40" class="form-control"  id="password" name="password" type="Password" value="<?php echo $texto_original; ?>">
											</div>
			    </div>
		      	<p class="text-center">
