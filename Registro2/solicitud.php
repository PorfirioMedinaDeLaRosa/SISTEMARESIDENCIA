...
if (isset($_POST['subir'])) {
   ...
   $sql = "INSERT INTO solicitud(tamanioSS,tipoSS,nombre_archivoSS, no_control) VALUES('$tamanio','$tipo','$nombre', '$no_control')";
...
$sql = " UPDATE  solicitud SET  tamanioSS=' $tamanio'  ,     tipoSS=' $tipo' ,  nombre_archivoSS= '$nombre'  where no_control='$no_control'";         
