...
//Si se ha pulsado el botón de buscar
    ...
    //Conectamos con la base de datos en la que vamos a buscar
     ...
     //   $db->query('set name utf8');
       ...
       $sql = "SELECT * FROM presidente where idP='$idGT'";
            $query = $db->execute($sql);
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
			      ...
			      <input  id="idP" name="idP" type="hidden"  value="<?php echo $datos['idP']; ?>"></input> 
			     <div class="form-group label-floating">
			      
											  <label for="nombre">Nombre:</label>
											  <input  onkeyup="validar()" maxlength="50" class="form-control" type="text" id="nombregt" name="nombregt" value="<?php echo $datos['NombreP']; ?>" >
					</div>  
			       <div class="form-group label-floating">
			      
											  <label for="nombre">Cargo:</label>
											  <input  onkeyup="validar()" maxlength="100"  class="form-control" type="text" id="cargogt" name="cargogt" value="<?php echo $datos['Cargo']; ?>">
					</div>
											...
											<div class="form-group label-floating">
											  ...
											  <input onkeyup="validar()" maxlength="50"  class="form-control" id="emailgt" name="emailgt" type="Email" value="<?php echo $datos['EmailP']; ?>" >
											  <span id="emailOK"></span>
											</div>
											<div class="form-group label-floating">
											  <label for="telefono">Teléfono:</label>
											  <input onkeyup="validar()" maxlength="15"  class="form-control" type="text" id="telefonogt" name="telefonogt" value="<?php echo $datos['TelefonoP']; ?>" >
											  <span id="telefonoOK"></span>
											</div>
											
											<div class="form-group label-floating">
											  <label for="password">Password:</label>
									<input onkeyup="validar()" maxlength="40"   class="form-control"  id="passwordgt" name="passwordgt" type="Password" value="<?php echo $texto_original; ?>">
											</div>
...
<script>
 ...
 $(document).ready(function(){  
      ...
      $('#submit').click(function(){            
           $.ajax({  
                url:"../Actualizacion2/actualizarP.php",  
                method:"POST",  
