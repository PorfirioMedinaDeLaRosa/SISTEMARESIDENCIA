...
$('.btn-exit-system').on('click', function(){
		swal({
		  	title: 'CERRAR SESIÓN?',
		  	text: "USTED DESEA SALIR DEL SISTEMA",
		  	type: 'warning',
	...
	$('.btn-search').on('click', function(){
		swal({
		  ...
		  html: '<div class="form-group label-floating">'+
			  		...
			  		'<input class="form-control" id="InputSearch" type="text">'+'<input class="form-control" id="InputSearch" type="text">'+
				'</div>'
		}).then(function () {
		  swal(
		    'You wrote',
...
$('.btn btn-success btn-raised btn-xs ').on('click', function(){
		$('#Dialog-Actualizar').modal('show');
